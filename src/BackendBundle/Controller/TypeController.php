...
class TypeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tracks = $em->getRepository('BackendBundle:Type')->findAll();
    ...
    {
        $type = new Type();
        $form = $this->createForm('BackendBundle\Form\TypeType', $type);
    ...
    {
        $deleteForm = $this->createDeleteForm($type);
        $editForm = $this->createForm('BackendBundle\Form\TypeType', $type);
     ...
     *
     * @param Track $type The type entity
     *
    ...
    private function createDeleteForm(Type $type)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('type_delete', array('id' => $track->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
